// 1. Write a function that will iterate over an alphabetized string and return the missing letter. If there isn't a missing letter, return "no missing letters".
//Example:
    // input: 'qrsuv'
    // output: 't'
//Example:
...
// 3. Given an array of numbers, sort the array such that all even numbers don't change their position but all odd numbers are sorted in ascending order. Return the sorted array.
// Example: 
